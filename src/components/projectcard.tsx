...
export const ProjectCard = ({
  ...
  <div className="flex flex-col sm:flex-row sm:grid sm:grid-cols-6 gap-4 sm:w-[600px] sm:mx-auto lg:w-[1000px] lg:mx-auto items-center h-full">
    ...
    {/* Thumbnail at the top for mobile, on the left side for larger screens */}  
    ...
    {/* Right side content takes up full width on mobile, 4 columns on larger screens */}
    <div className="w-full sm:col-span-4 flex flex-col space-y-3 pl-4 h-full pt-2 sm:pt-0">
      ...
      <div className="flex flex-row justify-between items-center sm:mt-3 pr-3">
        <a href={prodLink} target="_blank" rel="noopener noreferrer" className="flex flex-row space-x-2 items-center">
      ...
      {/* Description */}
      <p className="text-base sm:text-left text-justify sm:pt-4 pr-4 pt-2">{description}</p>
